...
class ALUTest implements ProcTestUtility {
    ...
    void addRegRegTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            Assertions.assertEquals(25, r1.getValue());
            Assertions.assertEquals(0, specOut.getValue());
            Assertions.assertTrue(flagTest.test());
        }));
    }
    ...
    void addZeroFlagTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_ADD, r1, r2));
            Assertions.assertEquals(0, r1.getValue());
            Assertions.assertEquals(0, specOut.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.ZERO_FLAG));
        }));
    }
    ...
    void addRegRegOverflowTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_ADD, r1, r2));
            Assertions.assertEquals((char)0xFFFE, r1.getValue());
            Assertions.assertEquals(0, specOut.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.OVERFLOW_FLAG));
        }));
    }
    ...
    void addRegRegNegativeTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_ADD, r1, r2));
            Assertions.assertEquals((char)0xFFFD, r1.getValue()); // -3
            Assertions.assertTrue(flagTest.test(FlagRegister.OVERFLOW_FLAG));
            Assertions.assertEquals(0, specOut.getValue());
        }));
    }
    ...
    void addRegRegNPNTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_ADD, r1, r2));
            Assertions.assertEquals((char)0xFFFF, r1.getValue()); // -1
            Assertions.assertTrue(flagTest.test());
            Assertions.assertEquals(0, specOut.getValue());
        }));
    }
    ...
    void addRegRegNPPTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_ADD, r1, r2));
            Assertions.assertEquals((char)0x0001, r1.getValue()); // 1
            Assertions.assertTrue(flagTest.test(FlagRegister.OVERFLOW_FLAG));
            Assertions.assertEquals(0, specOut.getValue());
        }));
    }
    ...
    void subRegRegTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            Assertions.assertEquals((char)0x0001, r1.getValue());
            Assertions.assertTrue(flagTest.test());
            Assertions.assertEquals(0, specOut.getValue());
        }));
    }
    ...
    void subRegRegZeroTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_SUB, r1, r2));
            Assertions.assertEquals((char)0x0000, r1.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.ZERO_FLAG));
            Assertions.assertEquals(0, specOut.getValue());
        }));
    }
    ...
    void subRegRegPPNTest2() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_SUB, r1, r2));
            Assertions.assertEquals((char)0xFFFE, r1.getValue()); // -2
            Assertions.assertTrue(flagTest.test(FlagRegister.OVERFLOW_FLAG));
            Assertions.assertEquals(0, specOut.getValue());
        }));
    }
    ...
    void subRegRegnNPNTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var r2 = new TestRegister(0x0002);
            alu.execute(new Instruction(InstructionType.ALU_SUB, r1, r2));
            Assertions.assertEquals((char)0xFFFA, r1.getValue()); // -6
            Assertions.assertTrue(flagTest.test());
            Assertions.assertEquals(0, specOut.getValue());
        }));
    }
    ...
    void subRegRegnNPPTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_SUB, r1, r2));
            Assertions.assertEquals((char)0x0002, r1.getValue());
            Assertions.assertTrue(flagTest.test());
            Assertions.assertEquals(0, specOut.getValue());
        }));
    }
    ...
    void umulRegRegTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            Assertions.assertEquals((char)0x0020, r1.getValue());
            Assertions.assertTrue(flagTest.test());
            Assertions.assertEquals(0, specOut.getValue());
        }));
    }
    ...
    void umulRegRegOverflowTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_UMUL, r1, r2));
            Assertions.assertEquals((char)0x0200, r1.getValue());
            Assertions.assertEquals((char)0x0001, specOut.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.OVERFLOW_FLAG));
        }));
    }
    ...
    void umulRegRegOverflowTest2() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var r2 = new TestRegister(0x0102);
            alu.execute(new Instruction(InstructionType.ALU_UMUL, r1, r2));
            Assertions.assertEquals((char)0xC000, r1.getValue());
            Assertions.assertEquals((char)0x0060, specOut.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.OVERFLOW_FLAG));
        }));
    }
    ...
    void umulRegRegOverflowTestZero() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_UMUL, r1, r2));
            Assertions.assertEquals((char)0x0000, r1.getValue());
            Assertions.assertEquals((char)0x0100, specOut.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.OVERFLOW_FLAG));
        }));
    }
    ...
    void umulRegRegNPNTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var r2 = new TestRegister(0x0001);
            alu.execute(new Instruction(InstructionType.ALU_UMUL, r1, r2));
            Assertions.assertEquals((char)0xFFFC, r1.getValue()); // 65532
            Assertions.assertEquals(0, specOut.getValue());
            Assertions.assertTrue(flagTest.test());
        }));
    }
    ...
    void umulRegRegNNPTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_UMUL, r1, r2));
            Assertions.assertEquals((char)0x0010, r1.getValue());
            Assertions.assertEquals((char)0xFFF8, specOut.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.OVERFLOW_FLAG));
        }));
    }
    ...
    void smulRegRegPPPTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            Assertions.assertEquals((char)0x0100, r1.getValue());
            Assertions.assertEquals((char)0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test());
        }));
    }
    ...
    void smulRegRegNPNTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_SMUL, r1, r2));
            Assertions.assertEquals((char)0xFFEC, r1.getValue()); // -20
            Assertions.assertEquals((char)0xFFFF, specOut.getValue()); // remaining negative bits
            Assertions.assertEquals((0xFFFFL << 16) + 0xFFEC, ((long) specOut.getValue() << 16) + r1.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.OVERFLOW_FLAG));
        }));
    }
    ...
    void smulRegRegPNNOverflowTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var r2 = new TestRegister(0xFFFC); // -4
            alu.execute(new Instruction(InstructionType.ALU_SMUL, r1, r2));
            Assertions.assertEquals((char)0x0004, r1.getValue()); // -20
            Assertions.assertEquals((char)0xFFFE, specOut.getValue()); // remaining negative bits + remainder of op
            Assertions.assertEquals((0xFFFEL << 16) + 0x0004, ((long) specOut.getValue() << 16) + r1.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.OVERFLOW_FLAG));
        }));
    }
    ...
    void smulRegRegNNPOverflowTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_SMUL, r1, r2));
            Assertions.assertEquals((char)0xFFF0, r1.getValue());
            Assertions.assertEquals((char)0x0001, specOut.getValue());
            // 131056
            Assertions.assertEquals((0x0001L << 16) + 0xFFF0, ((long) specOut.getValue() << 16) + r1.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.OVERFLOW_FLAG));
        }));
    }
    ...
    void udivRegRegPPTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            Assertions.assertEquals((char)0x0005, r1.getValue());
            Assertions.assertEquals((char)0x0003, specOut.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.OVERFLOW_FLAG));
        }));
    }
    ...
    void udivRegRegPPTest2() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var r2 = new TestRegister(0x0001);
            alu.execute(new Instruction(InstructionType.ALU_UDIV, r1, r2));
            Assertions.assertEquals((char)0x7FFF, r1.getValue());
            Assertions.assertEquals((char)0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test());
        }));
    }
    ...
    void udivRegRegPPTest3() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var r2 = new TestRegister(0x0001);
            alu.execute(new Instruction(InstructionType.ALU_UDIV, r1, r2));
            Assertions.assertEquals((char)0xFFFF, r1.getValue());
            Assertions.assertEquals((char)0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test());
        }));
    }
    ...
    void udivRegRegPPTest4() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var r2 = new TestRegister(0x0002);
            alu.execute(new Instruction(InstructionType.ALU_UDIV, r1, r2));
            Assertions.assertEquals((char)0x7FFF, r1.getValue()); // 32767
            Assertions.assertEquals((char)0x0001, specOut.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.OVERFLOW_FLAG));
        }));
    }
    ...
    void udivRegRegPPTest6() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_UDIV, r1, r2));
            Assertions.assertEquals((char)0x0001, r1.getValue());
            Assertions.assertEquals((char)0x6000, specOut.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.OVERFLOW_FLAG));
        }));
    }
    ...
    void udivRegRegZeroFlag() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_UDIV, r1, r2));
            Assertions.assertEquals((char)0x0000, r1.getValue());
            Assertions.assertEquals((char)0x0002, specOut.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.OVERFLOW_FLAG));
        }));
    }
    ...
    void udivRegRegDivZero() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var r2 = new TestRegister(0x0000);
            alu.execute(new Instruction(InstructionType.ALU_UDIV, r1, r2));
            Assertions.assertEquals((char)0x0014, r1.getValue()); // unchanged
            Assertions.assertEquals((char)0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.DIV_ZERO_FLAG));
        }));
    }
    ...
    void sdivRegRegNPTest1() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_SDIV, r1, r2));
            Assertions.assertEquals((char)0xFFFE, r1.getValue()); // -2
            Assertions.assertEquals((char)0xFFFC, specOut.getValue()); // -4
            Assertions.assertTrue(flagTest.test(FlagRegister.OVERFLOW_FLAG));
        }));
    }
    ...
    void sdivRegRegNPTest2() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_SDIV, r1, r2));
            Assertions.assertEquals((char)0xFFFE, r1.getValue()); // -2
            Assertions.assertEquals((char)0xFFFB, specOut.getValue()); // -5
            Assertions.assertTrue(flagTest.test(FlagRegister.OVERFLOW_FLAG));
        }));
    }
    ...
    void sdivRegRegNPZeroTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_SDIV, r1, r2));
            Assertions.assertEquals((char)0x0000, r1.getValue());
            Assertions.assertEquals((char)0xFFFC, specOut.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.OVERFLOW_FLAG));
        }));
    }
    ...
    void sdivRegRegPNZeroTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_SDIV, r1, r2));
            Assertions.assertEquals((char)0x0000, r1.getValue());
            Assertions.assertEquals((char)0x000A, specOut.getValue()); // 10
            Assertions.assertTrue(flagTest.test(FlagRegister.OVERFLOW_FLAG));
        }));
    }
    ...
    void sdivRegRegNNTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var r2 = new TestRegister(0xFFFC); // -4
            alu.execute(new Instruction(InstructionType.ALU_SDIV, r1, r2));
            Assertions.assertEquals((char)0x0003, r1.getValue());
            Assertions.assertEquals((char)0xFFFD, specOut.getValue()); // -3
            Assertions.assertTrue(flagTest.test(FlagRegister.OVERFLOW_FLAG));
        }));
    }
    ...
    void sdivRegRegPZeroDivByZeroTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var r2 = new TestRegister(0x0000);
            alu.execute(new Instruction(InstructionType.ALU_SDIV, r1, r2));
            Assertions.assertEquals((char)0x0005, r1.getValue()); // unchanged
            Assertions.assertEquals((char)0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.DIV_ZERO_FLAG));
        }));
    }
    ...
    void sdivRegRegNZeroDivByZeroTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var r2 = new TestRegister(0x0000);
            alu.execute(new Instruction(InstructionType.ALU_SDIV, r1, r2));
            Assertions.assertEquals((char)0xFFFB, r1.getValue()); // unchanged
            Assertions.assertEquals((char)0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.DIV_ZERO_FLAG));
        }));
    }
    ...
    void orRegRegTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            Assertions.assertEquals((char) 0x0031, r1.getValue());
            Assertions.assertEquals((char) 0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test());
        }));
    }
    ...
    void andRegRegTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            Assertions.assertEquals((char) 0x0210, r1.getValue());
            Assertions.assertEquals((char) 0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test());
        }));
    }
    ...
    void andRegRegTest2() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var r2 = new TestRegister(0xEFEF);
            alu.execute(new Instruction(InstructionType.ALU_AND, r1, r2));
            Assertions.assertEquals((char) 0xEEEE, r1.getValue());
            Assertions.assertEquals((char) 0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test());
        }));
    }
    ...
    void xorRegRegTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            Assertions.assertEquals((char) 0x0421, r1.getValue());
            Assertions.assertEquals((char) 0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test());
        }));
    }
    ...
    void xorRegRegTest2() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var r2 = new TestRegister(0xEFEF);
            alu.execute(new Instruction(InstructionType.ALU_XOR, r1, r2));
            Assertions.assertEquals((char) 0x1111, r1.getValue());
            Assertions.assertEquals((char) 0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test());
        }));
    }
    ...
    void notRegTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            Assertions.assertEquals((char) 0xEDCB, r1.getValue());
            Assertions.assertEquals((char) 0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test());
        }));
    }
    ...
    void shlRegRegTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            Assertions.assertEquals((char) 0x0008, r1.getValue());
            Assertions.assertEquals((char) 0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test());
        }));
    }
    ...
    void shlRegRegTestTrim2() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var r2 = new TestRegister(0x0008);
            alu.execute(new Instruction(InstructionType.ALU_SHL, r1, r2));
            Assertions.assertEquals((char) 0xF700, r1.getValue());
            Assertions.assertEquals((char) 0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test());
        }));
    }
    ...
    void shlRegRegTestTrim3() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var r2 = new TestRegister(0x0004);
            alu.execute(new Instruction(InstructionType.ALU_SHL, r1, r2));
            Assertions.assertEquals((char) 0xFF70, r1.getValue());
            Assertions.assertEquals((char) 0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test());
        }));
    }
    ...
    void shlRegRegTestTrim4() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var r2 = new TestRegister(0x0002);
            alu.execute(new Instruction(InstructionType.ALU_SHL, r1, r2));
            Assertions.assertEquals((char) 0xFFDC, r1.getValue());
            Assertions.assertEquals((char) 0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test());
        }));
    }
    ...
    void shrRegRegTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            Assertions.assertEquals((char) 0x00F0, r1.getValue());
            Assertions.assertEquals((char) 0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test());
        }));
    }
    ...
    void shrRegRegZeroTest2() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var r2 = new TestRegister(0x0004);
            alu.execute(new Instruction(InstructionType.ALU_SHR, r1, r2));
            Assertions.assertEquals((char) 0x00FF, r1.getValue());
            Assertions.assertEquals((char) 0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test());
        }));
    }
    ...
    void shrRegRegZeroTest3() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var r2 = new TestRegister(0x0002);
            alu.execute(new Instruction(InstructionType.ALU_SHR, r1, r2));
            Assertions.assertEquals((char) 0x03DD, r1.getValue());
            Assertions.assertEquals((char) 0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test());
        }));
    }
    ...
    void shrRegRegZeroTest4() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var r2 = new TestRegister(0x0001);
            alu.execute(new Instruction(InstructionType.ALU_SHR, r1, r2));
            Assertions.assertEquals((char) 0x07BA, r1.getValue());
            Assertions.assertEquals((char) 0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test());
        }));
    }
    ...
    void compareRegRegPPEqTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            Assertions.assertEquals((char)0x0005, r1.getValue());
            Assertions.assertEquals((char)0x0005, r2.getValue());
            Assertions.assertEquals((char)0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.EQUAL_FLAG));
        }));
    }
    ...
    void compareRegRegPPLeTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var r2 = new TestRegister(0x0005);
            alu.execute(new Instruction(InstructionType.ALU_CMP, r1, r2));
            Assertions.assertEquals((char)0x0004, r1.getValue());
            Assertions.assertEquals((char)0x0005, r2.getValue());
            Assertions.assertEquals((char)0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.LESS_FLAG));
        }));
    }
    ...
    void compareRegRegPPGtTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_CMP, r1, r2));
            Assertions.assertEquals((char)0x0005, r1.getValue());
            Assertions.assertEquals((char)0x0004, r2.getValue());
            Assertions.assertEquals((char)0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test());
        }));
    }
    ...
    void compareRegRegNNEqTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_CMP, r1, r2));
            Assertions.assertEquals((char)0xFFFD, r1.getValue());
            Assertions.assertEquals((char)0xFFFD, r2.getValue());
            Assertions.assertEquals((char)0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.EQUAL_FLAG));
        }));
    }
    ...
    void compareRegRegNNLeTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_CMP, r1, r2));
            Assertions.assertEquals((char)0xFFFC, r1.getValue());
            Assertions.assertEquals((char)0xFFFD, r2.getValue());
            Assertions.assertEquals((char)0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test(FlagRegister.LESS_FLAG));
        }));
    ...
    void compareRegRegNNGtTest() {
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_CMP, r1, r2));
            Assertions.assertEquals((char)0xFFFD, r1.getValue());
            Assertions.assertEquals((char)0xFFFC, r2.getValue());
            Assertions.assertEquals((char)0x0000, specOut.getValue());
            Assertions.assertTrue(flagTest.test());
        }));
    }
    ...
    void addOutParamSupport() {
        ...
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var p2 = new Constant((char)0x00FF);
            alu.execute(new Instruction(InstructionType.ALU_ADD, p1, p2));
            Assertions.assertEquals((char)0xFFFF, p1.getValue());
        }));
    }
    ...
    void subOutParamSupport() {
        ...
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var p2 = new Constant((char)0x00FF);
            alu.execute(new Instruction(InstructionType.ALU_SUB, p1, p2));
            Assertions.assertEquals((char)0xFE01, p1.getValue());
        }));
    }
    ...
    void smulOutParamSupport() {
        ...
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_SMUL, p1, p2));
            Assertions.assertEquals((char)0x0008, p1.getValue());
        }));
    }
    ...
    void sdivOutParamSupport() {
        ...
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            alu.execute(new Instruction(InstructionType.ALU_SDIV, p1, p2));
            Assertions.assertEquals((char)0x0002, p1.getValue());
        }));
    }
    ...
    void andOutParamSupport() {
        ...
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var p2 = new Constant((char)0x55FF);
            alu.execute(new Instruction(InstructionType.ALU_AND, p1, p2));
            Assertions.assertEquals((char)0x5555, p1.getValue());
        }));
    }
    ...
    void xorOutParamSupport() {
        ...
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var p2 = new Constant((char)0x55FF);
            alu.execute(new Instruction(InstructionType.ALU_XOR, p1, p2));
            Assertions.assertEquals((char)0xAAAA, p1.getValue());
        }));
    }
    ...
    void shlOutParamSupport() {
        ...
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var p2 = new Constant((char)0x0004);
            alu.execute(new Instruction(InstructionType.ALU_SHL, p1, p2));
            Assertions.assertEquals((char)0x0F00, p1.getValue());
        }));
    }
    ...
    void shrOutParamSupport() {
        ...
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var p2 = new Constant((char)0x0004);
            alu.execute(new Instruction(InstructionType.ALU_SHR, p1, p2));
            Assertions.assertEquals((char)0x000F, p1.getValue());
        }));
    }
    ...
    void notOutParamSupport() {
        ...
        exceptionLess(() -> aluTest((alu, flagTest, specOut) -> {
            ...
            var p2 = new Constant((char)0x0000);
            alu.execute(new Instruction(InstructionType.ALU_NOT, p1, p2));
            Assertions.assertEquals((char)0xFF0F, p1.getValue());
        }));
    }
